...
namespace RevitNodesTests.Elements
{
    ...
    class RoofTypeTests : RevitNodeTestBase
    {
        ...
        public void CanGetRoofTypeThermalProperties()
        {
            ...
            double resultRoofTypeThermalTransmittance = (double)thermalProperties["ThermalTransmittance"];
            ...
            Assert.AreEqual(expectedRoofTypeThermalTransmittance, resultRoofTypeThermalTransmittance, Tolerance);
