...
namespace RevitNodesTests.Elements
{
    ...
    public class FamilyTypeTests : RevitNodeTestBase
    {
        ...
        [Ignore("Template file missing - TODO: check if this is still true")]
        [TestModel(@".\empty.rvt")]
        public void ByGeometry_GoodArgs()
        {
            ...
            path = System.IO.Path.Combine(path, @"Autodesk\RVT 2018\Family Templates\English\Metric Generic Model.rft");
