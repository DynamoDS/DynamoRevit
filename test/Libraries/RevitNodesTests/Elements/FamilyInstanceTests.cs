...
namespace RevitNodesTests.Elements
{
    ...
    public class FamilyInstanceTests : RevitNodeTestBase
    {
        ...
        //    Assert.AreEqual(0, position.X, "X property does not match");
        //    Assert.AreEqual(0, position.Y, "Y property does not match");
        //    Assert.AreEqual(0, position.Z, "Z property does not match");

        //    //Assert.AreEqual(importinstance1.InternalElement.refere, famInst.InternalFamilyInstance.HostFace);
        //}
    }
}
