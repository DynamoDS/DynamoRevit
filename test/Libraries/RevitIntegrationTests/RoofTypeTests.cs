...
namespace RevitSystemTests
{
    ...
    class RoofTypeTests : RevitSystemTestBase
    {
        ...
        public void CanGetRoofTypeThermalProperties()
        {
            ...
            double expectedRoofTypeThermalTransmittance = 0.15892777;
            ...
            var resultRoofTypeThermalTransmittance = GetPreviewValue("6d63251353044032b5167428b7749f62");
            ...
            Assert.AreEqual(expectedRoofTypeThermalTransmittance, (double)resultRoofTypeThermalTransmittance, Tolerance);
