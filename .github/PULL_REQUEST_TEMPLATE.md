...
5. PRs made to the `DynamoRevit` repo will need to be cherry-picked into all the Revit branches that Dynamo supports. Contributors will be responsible for cherry-picking their reviewed commits to the other branches after a `LGTM` label is added to the PR.
