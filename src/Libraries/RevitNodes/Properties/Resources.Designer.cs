...
namespace Revit.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Element location not extractable.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Element does not have a location that can be updated.
        /// </summary>
        internal static string InvalidLocationUpdate {
            get {
                return ResourceManager.GetString("InvalidLocationUpdate", resourceCulture);
            }
        }
