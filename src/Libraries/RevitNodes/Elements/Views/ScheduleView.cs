...
using SchedulableField = Revit.Schedules.SchedulableField;
using ScheduleField = Revit.Schedules.ScheduleField;
using ScheduleFilter = Revit.Schedules.ScheduleFilter;
...
namespace Revit.Elements.Views
{
    ...
    public class ScheduleView : View
    {
        ...
        /// </summary>
        public override Autodesk.Revit.DB.Element InternalElement => InternalViewSchedule;
        ...
        public static ScheduleView CreateSchedule(Category category, string name, string scheduleType)
        {
            ...
            {
                throw new ArgumentNullException(Properties.Resources.ScheduleTypeArgumentException);
            }
