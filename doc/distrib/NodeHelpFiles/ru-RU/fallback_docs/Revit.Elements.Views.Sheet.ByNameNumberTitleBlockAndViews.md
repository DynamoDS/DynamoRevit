...
В данном примере создается один лист с именем DynamoDemo20. Входные виды НЕ могут находиться на существующих листах. Виды должны поместиться на листе, иначе они не будут размещены.
