...
Im folgenden Beispiel werden alle Entwurfsansichten aus dem aktuellen Revit-Dokument gesammelt. Der Maßstab der Ansichten wird dann mit `View.SetScale` auf 1/4" = 1'-0" (Skalierfaktor 48) festgelegt.
___
## Beispieldatei
